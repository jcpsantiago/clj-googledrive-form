...
(defn home-page [inner-viz success-viz]
  ...
  (html5 {:lang "en"}
            ...
            [:div {:class (str "forminner " inner-viz)}
             ...
             ;; -- csv input --
              [:div {:class "mt3"}
               ...
               ;; -- submit button --
             [:div {:class "mt4"}
              [:button {:class "b ph3 pv2 input-reset ba b--black white
                               pointer f6 bg-animate bg-black hover-pink"
                        :type "submit" :name "lose-file" :formnovalidate ""} "Lose it forever"]]]
         ...
         ;; -- change the text in the "choose data" button to reflect the file --
